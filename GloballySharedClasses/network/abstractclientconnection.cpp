...
void AbstractClientConnection::setProtocolKnowerFactory(IProtocolKnowerFactory *protocolKnowerFactory)
{
    m_ProtocolKnowerFactory = protocolKnowerFactory;
}
void AbstractClientConnection::potentialMergeCaseAsCookieIsSupplied()
{
    ...
    AbstractClientConnection *toMergeWithMaybe = getExistingConnectionUsingCookie__OrZero(cookie());
    if(toMergeWithMaybe)
    {
        ...
        if(!m_TheMessageByteArray.isNull() && !m_TheMessageByteArray.isEmpty())
        {
            ...
            switch(currentState)
            {
                ...
                case DoneHelloing: //optimize for DoneHelloing case, as it will be used the most times over and over and over and over and over during production
                {
                    ...
                    m_ProtocolKnower->messageReceived(&m_TheMessageByteArray /*, cookie()*/);
                }
                break;
                case AwaitingHello:
                {
