...
//API
#define ABC2_API_HTTP_PATH "/api"
#define ABC2_API_ACTION_HTTP_GET_PARAM "action"

#define ABC2_API_GET_CURRENT_AD_ACTION "getcurrentad"
#define ABC2_API_GET_CURRENT_AD_ACTION_USER_HTTP_GET_PARAM "user"
#define ABC2_API_GET_CURRENT_AD_ACTION_INDEX_HTTP_GET_PARAM "index"
