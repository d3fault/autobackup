...
//TODOreq: url/hovertext/image-extension can't be changed in the static index.html xD... maybe I should use a templating system? Maybe I should just get the javascript version working?
//The idea was to have this be a cron-job script and to keep it separate from a user's index.html. I should instead do an index.php (the html is embedded) example. This does give me something to test at least...
