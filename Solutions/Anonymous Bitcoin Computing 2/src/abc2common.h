...
#define ABC_MIN_AD_SLOT_FILLER_IMAGE_WIDTH_AND_HEIGHT_PIXELS 16
#define ABC_MAX_AD_SLOT_FILLER_IMAGE_WIDTH_AND_HEIGHT_PIXELS 2048 /* TODOreq: under 20mb bmp, accounting for b64 + nickname/url/etc. NOTE: 2048x2048 bmp is 12mb, so 2048 seems good */
#define ABC_DEFAULT_AD_SLOT_FILLER_IMAGE_WIDTH_PIXELS 576
#define ABC_DEFAULT_AD_SLOT_FILLER_IMAGE_HEIGHT_PIXELS 96
...
#define ABC_API_SIMPLE_PHP_CLIENT_FILENAME "abc.api.simple.php.client.zip"
#define ABC_API_SIMPLE_PHP_CLIENT_URL "/" ABC_API_SIMPLE_PHP_CLIENT_FILENAME
#define ABC_API_SIMPLE_PHP_CLIENT_MIME_TYPE "application/zip"
