...
void AnonymousBitcoinComputingWtGUI::showHomeWidget()
{
    if(!m_HomeWidget)
    {
        ...
        new WText("Welcome to " ABC_HUMAN_READABLE_NAME_PLX ".<br /><br />" ABC_HUMAN_READABLE_NAME_PLX " is an advertising platform for both buying and selling ads. There's a 1.5% transaction fee and a 1.5% withdrawal fee. The reason it's so cheap is because I cut out the crooked credit card middle men, which saves money both on fees and on backcharges. " ABC_HUMAN_READABLE_NAME_PLX " allows you to advertise on regular websites, tor hidden services, or anywhere else you can think of. Unlike other advertising agencies (not naming names, but a giant search engine comes to mind), we don't use our 'terms of service' as a means of censoring you. There is only one rule: don't break the law.<br /><br />Selling advertising (website owners placing ads on their site) works like this: You choose your ad's dimensions (width x height of the ad image), prohibited categories, the duration that an ad will be shown on your site for when someone purchases it, and the minimum purchase price for that duration. The cost to rent your ad space doubles in price every time someone purchases it, then trickles back down to your chosen minimum price and settles back on it the moment the last ad expires. You should always choose a low minimum price, because you always want your ad space to be purchased, but the \"doubling\" algorithm keeps the price high and makes advertisers compete with each other for your ad space. For a simple example of the \"doubling\" algorithm in action, consider the following: If your minimum price was set at $1 USD and your ad's duration was 24 hours, and you had the next 30 days worth of ads already reserved/sold, your ad space would cost advertisers $1,073,741,824 USD for the 31st day. That price would be falling fast back down to $1 over the course of the month (the price updates every second). If nobody had purchased it in 15 days, it will have dropped to a mere $32,768 USD. Finally, the moment the last ad expires, it sits back at $1 USD.<br /><br /><br />", m_HomeWidget);
