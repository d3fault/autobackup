...
- [intermittent] Segfault when stopping the app when deleting new subscribers. Since the app won't be stopping very often :-P, it's a 1.1 bug. Line 232 of couchbasedb.cpp, "delete subscription;"
