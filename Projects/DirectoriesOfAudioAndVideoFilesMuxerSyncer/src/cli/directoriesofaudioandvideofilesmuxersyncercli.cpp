...
//TODOoptional: --add-pre-audio-input-ffmpeg-arg and --add-pre-video-input-ffmpeg-arg (the list goes before the corresponding "-i" flags). unleashes more ffmpeg stuff
