...
void BankServer::connectRpcBankServerClientActionRequestSignalsToBankServerImplSlots(IEmitRpcBankServerClientActionRequestSignalsWithMessageAsParam *actionRequestSignalEmitter)
{
    ...
    connect(actionRequestSignalEmitter, SIGNAL(createBankAccount(ServerCreateBankAccountMessage*)), m_BankDbHelper, SLOT(createBankAccount(ServerCreateBankAccountMessage*)));
    connect(actionRequestSignalEmitter, SIGNAL(getAddFundsKey(ServerGetAddFundsKeyMessage*)), m_BankDbHelper, SLOT(getAddFundsKey(ServerGetAddFundsKeyMessage*)));
