...
class IEmitRpcBankServerActionRequestSignalsWithMessageAsParam : public IAcceptRpcBankServerMessageDeliveries
{
    Q_OBJECT
public:
    IEmitRpcBankServerActionRequestSignalsWithMessageAsParam(QObject *parent = 0);
signals:
