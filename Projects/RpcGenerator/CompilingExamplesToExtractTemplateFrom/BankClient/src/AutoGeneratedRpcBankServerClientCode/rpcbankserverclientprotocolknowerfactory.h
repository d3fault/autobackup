...
public:
    ...
    static void setSignalRelayHackEmitter(IAcceptRpcBankServerClientActionDeliveries_AND_IEmitBroadcastsForSignalRelayHack *signalRelayHackEmitter) { RpcBankServerClientProtocolKnower::setSignalRelayHackEmitter(signalRelayHackEmitter); }
