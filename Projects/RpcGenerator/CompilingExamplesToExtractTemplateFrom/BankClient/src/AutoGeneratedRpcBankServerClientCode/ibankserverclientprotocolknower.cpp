...
ClientCreateBankAccountMessage *IBankServerClientProtocolKnower::getPendingCreateBankAccountMessageById(uint messageId)
{
...
ClientGetAddFundsKeyMessage *IBankServerClientProtocolKnower::getPendingGetAddFundsKeyMessageById(uint messageId)
{
