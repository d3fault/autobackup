    ...
    : QWidget(parent)
{
    ...
    QWebSettings::globalSettings()->setAttribute(QWebSettings::JavascriptEnabled, false); //TODOreq: on first run explain and ask "secure vs insecure" mode. space-bar/enter (yes junkies) = "secure" mode (javascript disabled)
