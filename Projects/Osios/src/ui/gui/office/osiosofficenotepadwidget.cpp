    ...
    : QWidget(parent)
{
    ...
    QPushButton *switchToOfficeSuiteButton = new QPushButton(tr("Switch to Office Productivity Suite")); //TODOreq: just some qt wysiwyg editor for now... maybe just a QTextEdit (not plain)... idk (or care much). TODOoptional: perhaps said office productivity suite is itself a tabwidget with a doc/spreadsheet/presentation/etc sub-tabs
