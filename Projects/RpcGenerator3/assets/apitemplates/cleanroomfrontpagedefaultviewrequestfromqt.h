...
class %API_CALL_TO_REQUEST_BASE_NAME%FromQt : public I%API_CALL_TO_REQUEST_BASE_NAME%
{
    Q_OBJECT
public:
    %API_CALL_TO_REQUEST_BASE_NAME%FromQt(I%API_NAME% *%API_AS_VARIABLE_NAME%, QObject *objectCallback, const char *slotCallback%API_CALL_ARG_TYPES_AND_NAMES_WITH_LEADING_COMMASPACE_IF_ANY_ARGS%);
