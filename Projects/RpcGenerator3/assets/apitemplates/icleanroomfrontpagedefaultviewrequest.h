...
public:
    ...
    void processRequest();
    virtual void respond(bool internalError, bool %API_CALL_SLOT_NAME%Success%COMMASPACE_MAYBE%%API_CALL_RESPONSE_ARGS_AS_COMMA_SEPARATED_LIST_EXCLUDING_REQUEST_POINTER%)=0;%API_CALL_ARG_MEMBER_DEFINITIONS_IN_REQUEST_INTERFACE_HEADER%
signals:
