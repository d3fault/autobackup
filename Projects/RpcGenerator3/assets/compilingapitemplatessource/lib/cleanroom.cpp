...
//TODOoptional: AutoDb should come later, after AutoDrilldown. Another phrase for AutoDb is "object relation[al?] mapping (had:management)" or someshit (edit: actually, I think a json+tagging based doc store might be easier/better than ORM. idk, lots to consider). AutoDrilldown (AutoGui) sounds much more interesting/useful (but together, they sound an order of magnitude more useful than either one of them alone (mfw this very second (calm af. I feel like I've inherited the pure virtual interface of the world. Itself being an aggregation of trillions of other pure virtual interfaces)))
