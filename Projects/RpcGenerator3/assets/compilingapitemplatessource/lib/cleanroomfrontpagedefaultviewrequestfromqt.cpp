...
CleanRoomFrontPageDefaultViewRequestFromQt::CleanRoomFrontPageDefaultViewRequestFromQt(ICleanRoom *cleanRoom, CleanRoomSession parentSession, QObject *objectCallback, const char *slotCallback, double someArg0)
