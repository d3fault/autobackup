...
CleanRoomFrontPageDefaultViewRequestFromQt::CleanRoomFrontPageDefaultViewRequestFromQt(ICleanRoom *cleanRoom, QObject *objectCallback, const char *slotCallback, double someArg0)
