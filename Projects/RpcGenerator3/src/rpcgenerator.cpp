...
//TODOmb: When I'm braver and actually doing the whole "change api, delete header, re-gen to recreate header [with changed api]" workflow, might be nice to show what files were overwritten, what files were not overwritten, and what files were skipped because they already existed. Of course, showing this pre-generate would be even better, and having checkboxes next to the shits even moar better
