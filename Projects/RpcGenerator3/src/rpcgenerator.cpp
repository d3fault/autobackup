...
#define NoApiTypeAndVarNames QList<ApiTypeAndVarName>()
...
void RpcGenerator::generateRpc()
{
    ...
    /*TODOmb: api.declareDataType("Document",
    ...
    api.createApiCall("getLatestDocuments"
                          ...
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("QList<QDateTime>", "latestDocumentsTimestamps") << ApiTypeAndVarName("QList<QString>", "latestDocumentsUsernames") << ApiTypeAndVarName("QList<QByteArray>", "latestDocumentsDatas") << ApiTypeAndVarName("QList<QString>", "latestDocumentsLicenseIdentifiers")
    ...
    api.createApiCall("declareIntentToAttemptRegistration"
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("QString", "desiredUsername") << ApiTypeAndVarName("QString", "password") << ApiTypeAndVarName("bool", "acceptedCLA")
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("bool", "intentToRegisterDeclaredSuccessfully") << ApiTypeAndVarName("QString", "dataUserMustReciteInRegistrationAttemptVideo")
                      );
    ...
    api.createApiCall("submitRegistrationAttemptVideo"
                          ...
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("bool", "registrationAttemptVideoSubmissionSuccessful")
                      );

    api.createApiCall("login"
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("QString", "username") << ApiTypeAndVarName("QString", "password")
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("bool", "loginSuccessful")
                      );
    ...
    api.createApiCall("post"
                              ...
                              , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("bool", "postedSuccessfully") << ApiTypeAndVarName("QDateTime", "timestamp") << ApiTypeAndVarName("QByteArray", "docKey_aka_docHashHex")
                              , QStringList() << "<QDateTime>"
                              //, QStringList() << "<QDateTime>"
                          );
    /*api.createApiCall("post"
    ...
    api.createApiCall("logout"
                          , NoApiTypeAndVarNames
                          , QList<ApiTypeAndVarName>() << ApiTypeAndVarName("bool", "success")
                      );
#endif
...
TemplateBeforeAndAfterStrings_Type RpcGenerator::initialBeforeAndAfterStrings(Api *api)
{
    ...
    beforeAndAfterStrings.insert("%RPC_AUTO_GENERATED_FILE_WARNING%", "//##################\n//" + tr("WARNING: DO NOT MODIFY THIS FILE!") + "\n//This this file was automatically generated by Rpc Generator 3. If the rpc generator application is run again, your changes may be silently overwritten!\n//##################\n");
    beforeAndAfterStrings.insert("%RPC_AUTO_SKELETON_FILE_SUGGESTIONANDWARNING%", "//##################\n//" + tr("This file is an Rpc Generated Business Implementation Skeleton file. Changing it is allowed. If you delete this file, it will be re-generated the next time the Rpc Generator is run.") + "\n//##################\n");
    ...
    beforeAndAfterStrings.insert("%API_CALL_ADDITIONAL_INCLUDES_FOR_WHENEVER_THIS_API_CALLS_REQUEST_OR_RESPONSE_ARGS_ARE_PRESENT%", additionalIncludesRawCpp.join("\n"));
