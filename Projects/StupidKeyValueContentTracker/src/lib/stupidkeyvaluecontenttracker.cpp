...
#include "AutoGeneratedRequestResponseContractGlue/StupidKeyValueContentTracker/stupidkeyvaluecontenttrackerrequestresponsecontracts.h"

using namespace StupidKeyValueContentTrackerRequestResponseContracts;
...
{
    AddScopedResponder scopedResponder(m_Contracts->add());
    ...
    QSharedPointer<KeyValueStoreMutation_Add> addMutation(new KeyValueStoreMutation_Add(data));
...
{
    ModifyScopedResponder scopedResponder(m_Contracts->modify());
...
{
    RemoveKeyScopedResponder scopedResponder(m_Contracts->removeKey());
...
{
    ReadKeyScopedResponder scopedResponder(m_Contracts->readKey());
    ...
    scopedResponder.response()->setSuccess(found);
    scopedResponder.response()->setKey(key);
    scopedResponder.response()->setRevision(revision);
