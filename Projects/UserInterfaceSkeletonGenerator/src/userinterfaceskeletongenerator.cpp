...
void UserInterfaceSkeletonGenerator::generateRequestResponseContractGlueMaybe(const UserInterfaceSkeletonGeneratorData &data) const
{
    //TODOreq: mkdir AutoGeneratedRequestResponseContractGlue
...
void UserInterfaceSkeletonGenerator::generateUserInterfaceSkeletonFromData(const UserInterfaceSkeletonGeneratorData &data, QList<QString> implStubShortNames)
{
    ...
    generateRequestResponseContractGlueMaybe(data);
