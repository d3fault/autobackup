...
void UserInterfaceSkeletonGenerator::populateDataUsingHardCodedCppXD(UserInterfaceSkeletonGeneratorData &data)
{
    ...
    data.createAndAddRequestResponse_aka_SlotWithFinishedSignal("queryInstalledFormats", UserInterfaceSkeletonGeneratorData::ArgsList(), UserInterfaceSkeletonGeneratorData::ArgsList() << UserInterfaceSkeletonGeneratorData::SingleArg{"QList<QString>","installedFormats"});
}
