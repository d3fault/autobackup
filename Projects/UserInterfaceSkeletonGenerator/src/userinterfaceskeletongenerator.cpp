...
bool UserInterfaceSkeletonGenerator::generateRequestResponseContractGlueMaybe(const UserInterfaceSkeletonGeneratorData &data)
{
    ...
    QString targetDir_WithTrailingSlash = m_OutputDir_WithTrailingSlash + "AutoGeneratedRequestResponseContractGlue" + "/" + data.BusinessLogiClassName + "/";
...
{
    QFile businessObjectRequestResponseContractsHeaderFile(targetDir_WithTrailingSlash + data.BusinessLogiClassName.toLower() + "requestresponsecontracts.h");
    ...
    QString businessObjectRequestResponseContracts = data.BusinessLogiClassName + "RequestResponseContracts";
    ...
    t << "{" << endl;
    t << "public:" << endl;
    t << TAB << "explicit Contracts(" << data.BusinessLogiClassName << " *" << firstLetterToLower(data.BusinessLogiClassName) << ");" << endl;
    Q_FOREACH(const UserInterfaceSkeletonGeneratorData::RequestResponse_aka_SlotWithFinishedSignal_Data &currentContract, data.RequestResponses_aka_SlotsWithFinishedSignals)
    {
