...
void MouseOrMotionRectGrabberWithPeriodOfInactivityDetectionGui::mouseOrMotionRectGrabberWithPeriodOfInactivityDetectionReadyForConnections(QObject *mouseOrMotionRectGrabberWithPeriodOfInactivityAsQObject)
{
    ...
    connect(business, SIGNAL(mouseOrMotionRectGrabbed(QPoint,QImage,MouseOrMotionRectGrabberWithPeriodOfInactivityDetection::MouseOrMotionEnum)), m_Gui.data(), SLOT(handleMotionOrMotionRectGrabbed(QPoint,QImage,MouseOrMotionRectGrabberWithPeriodOfInactivityDetection::MouseOrMotionEnum)));
    ...
    QMetaObject::invokeMethod(business, "startGrabbingMouseOrMotionRectsWhileAlsoDetectingPeriodsOfInactivity", Q_ARG(QSize,rectSize), Q_ARG(int,2000), Q_ARG(int,10000));
}
