#ifndef RPCBUSINESSCONTROLLERIMPL_H
#define RPCBUSINESSCONTROLLERIMPL_H
...
class RpcBusinessControllerImpl : public IRpcBusinessController
{
    Q_OBJECT
public:
    explicit RpcBusinessControllerImpl(IRpcBusiness *business);
private:
...
#endif // RPCBUSINESSCONTROLLERIMPL_H
