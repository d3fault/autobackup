...
TARGET = rpcMessageDeliveryAndRecyclingThreadedBetterWithClientRequestMatching
TEMPLATE = app


SOURCES += main.cpp\
   
rpcmessagedeliveryandrecyclingthreadedbetterwithclientrequestmatchingtest.cpp \
