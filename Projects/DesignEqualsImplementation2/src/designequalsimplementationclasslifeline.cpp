...
{
    assignNonFunctionMemberAsClassLifelineInstance(parentClassChosenToGetNewNonFunctionMember->createNewNonFunctionMember(typeOfNewNonFunctionMember, typeOfNewNonFunctionMember->Name + " *", nameOfNewNonFunctionMember, Visibility::Private, TypeInstanceOwnershipOfPointedToDataIfPointer::OwnsPointedToData));
}
