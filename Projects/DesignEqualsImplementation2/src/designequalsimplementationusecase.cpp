...
void DesignEqualsImplementationUseCase::insertExistingSignalNewSlotEvent(int statementIndexOfExistingSignal, DesignEqualsImplementationClassSlot *sourceOrderedListOfStatements_OrZeroIfSourceIsActor, DesignEqualsImplementationClassSignal *designEqualsImplementationClassSignal, DesignEqualsImplementationClassSlot *designEqualsImplementationClassSlot, const SignalEmissionOrSlotInvocationContextVariables &signalEmissionContextVariables, DesignEqualsImplementationClassLifeLine *indexInto_m_ClassLifeLines_OfSignal, int indexInto_m_ClassLifeLines_OfSlot, int indexToInsertSlotIntoSignalSlotConnectionActivationList)
{
    ...
    insertEventPrivate(UseCaseExistingSignalNewSlotEventType, statementIndexOfExistingSignal, sourceOrderedListOfStatements_OrZeroIfSourceIsActor, designEqualsImplementationClassSlot, new SignalSlotCombinedEventHolder(designEqualsImplementationClassSignal, designEqualsImplementationClassSlot, indexToInsertSlotIntoSignalSlotConnectionActivationList), 0, signalEmissionContextVariables, indexInto_m_ClassLifeLines_OfSignal, indexInto_m_ClassLifeLines_OfSlot);
}
