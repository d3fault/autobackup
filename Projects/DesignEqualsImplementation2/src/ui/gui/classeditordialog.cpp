...
QWidget *ClassEditorDialog::createPropertiesClassEditorTab()
{
    ...
    //TODOreq: visibility radio, and I'm starting to think maybe Q_PROPERTY could ~sorta~ be a 'visibility' (in the enum too)
    //TODOreq: Q_PROPERTY checkbox, which makes available the following checkboxes as well. see above comment
