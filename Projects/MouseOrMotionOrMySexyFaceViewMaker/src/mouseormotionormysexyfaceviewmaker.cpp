...
//TODOreq: refactorthis to use the globally shared class MouseOrMotionOrPeriodOfInactivityDetector. A ton of code was jacked from this class when creating MouseOrMotionOrPeriodOfInactivityDetector
