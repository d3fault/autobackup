...
*/
#ifndef SIMPLESINGLEBACKEND2_H
#define SIMPLESINGLEBACKEND2_H

#include <QObject>
#include <QTimer>

class SimpleSingleBackend2 : public QObject
{
    Q_OBJECT
public:
    explicit SimpleSingleBackend2(QObject *parent = 0);
private:
    QTimer *m_Timer;
