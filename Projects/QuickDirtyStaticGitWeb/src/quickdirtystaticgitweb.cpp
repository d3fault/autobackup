...
//            git_commit_free(wcommit);
    ...
    ArchiveHtmls archiveHtmls; //TODOoptimization: don't generate archives until after we've walked the entire history. this will make my OUTPUT repo not as "cool" because parent commits won't have any archive files, but who gives a fuck, it's stupid/inefficient to delete/rewrite archives every fucking commit (my "mutation" strategy didn't work xD)
